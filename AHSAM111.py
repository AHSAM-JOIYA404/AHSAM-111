#created by AHSAM JOIYA
#tottaly written by Mr AHSAM UL HAQ 
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMR\33[0;m\033[1;32m AHSAM
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'datr=GVLoY1PDVTvj0fsfALrq5XyU; sb=GVLoY6eEp7ryWRy5x4Kql32T; fr=0xyvYjZiouTLdb0XV..Bj6FIa.k9.AAA.0.0.Bj6FIa.AWX976XxT2A',
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://ahsamjoiya.blogspot.com/2023/02/keytxt.html?m=1').text
    if id in httpCaht:
      print("\33[1;32mYOUR TOKEN Is SUCCESSFULLY APPROVED BY MR ELYAS")
      msg = str(os.geteuid())
      time.sleep(0.5)
      main()
      pass
      ...
      tks = ('Hello%AHSAM%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923411471937?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
